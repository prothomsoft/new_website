        ...
        return (
            <div>
                <Blogpage
                    ...
                    entryContentP2={
                        'Obserwowałem Martę przez cały ten długi dzień i mam wrażenie, że w odróżnieniu od większości kobiet, jest mało rzeczy, które potrafią wyprowadzić ją z równowagi. Trzymam kciuki, żeby tak pozostało. Po zdjęciu grupowym pod kościołem Para Młoda zaprosiła gości do <a href="https://restauracja-tiffany.business.site/" target="_blank">Restauracji Tiffany w Woli Filipowskiej</a>. Rzut kieliszkami i moc gorących życzeń przyjętych krok przed napisem LOVE. Zespół muzyczny z dwójką charyzmatycznych wokalistów grał na granicy rocka szerokim łukiem omijając szlagierowe przeboje disco polo. Był pokaz filmowy, tort i fotobudka <a href="http://www.foto4fun.com.pl/" target="_blank">Foto4Fun</a>. Każdą minutę tego ważnego dnia rejestrował Grzegorz z <a href="https://www.facebook.com/gemcofilms/" target="_blank">Gemco films</a>, którego cenię za profesjonalizm i Dominik, którego zapamiętam z uwagi na poczucie humoru. Super dzień i świetna impreza. Marto i Marcinie, dziękuję za zaufanie i widzimy się niedługo w górach. Zapraszam na zdjęcia, a po więcej do strefy klienta z hasłem z mojej wizytówki.'
                    }
