        ...
        return (
            <div>
                <article>
                    ...
                    <p>
                        Lądując na mojej stronie internetowej trafiliście do fotografa, który od zawsze proponuje, namawia, zachwala sesje zdjęciowe w Krakowie. Trafiliście do fotografa, który swoim
                        portfolio udowadnia, że nie trzeba jechać na koniec świata by zrobić dobre zdjęcia ślubne. Kraków znany w zimie głównie ze smogu już wiosną zamienia się w piękne, bardzo
                    ...
                    <p>
                        ...
                        Studio Qulinarne. Stare Miasto z ulicą Jagiellońska, Wawel, Planty, Zaułek Czartoryskich, Opera Krakowska, Sukiennice i Rynek Główny, Browar Lubicz, Hotel Stary - wymieniać
                        można długo. Przygotowując się do sesji zdjęciowej i szukając odpowiedzi na pytanie gdzie można zrobić foto sesję w krakowie, wpiszcie miejsca z powyższego paragrafu, a
                    ...
                    <p>
                        ...
                        analizowaniu moich i istniejacych już w internecie prac innych fotografów wykonanych w miejscu lub okolicach miejsca do którego się wybieramy.
                    </p>
                    <LazyLoad offsetVertical={300}>
                        <img src={"/static/portfolio/sesja_zdjeciowa_krakow_1_portfolio.jpg"} />
                    </LazyLoad>
                    <p>
                        Budowanie kreatywności, wyszukiwanie szczerości i wyjątkowości w zdjęciach to ciągła praca. Wierzcie mi, że im dalej jestem, tym więcej pracy widzę jeszcze przed sobą. Każda
                        kolejna wykonana sesja zdjęciowa buduje świadomość tego, co ma być w kadrze, jak tego czegoś szukać. Definiuje kadr, podpowiada co chcę pokazywać i jak chcę pokazywać.
                    </p>
                    <LazyLoad offsetVertical={300}>
                        <img src={"/static/portfolio/sesja_zdjeciowa_krakow_2_portfolio.jpg"} />
                    </LazyLoad>
                    <p>
                        Trzy godziny fotografowania, najczęściej dwa lub trzy wybrane miejsca w Krakowie i okolicach, blisko pięćset zdjęć, z których starannie selekcjonuję siedemdziesiąt do obróbki
                        ...
                        prawdziwości w moich zdjęciach, odnajdywaniu kadrów, odkrywaniu miejsc dzięki magii światła po raz kolejny na nowo.
                    </p>
                    <LazyLoad offsetVertical={300}>
                        <img src={"/static/portfolio/sesja_zdjeciowa_krakow_3_portfolio.jpg"} />
                    </LazyLoad>
                    <p>
                        Plener ślubny w Krakowie to najlepszy moment na zrobienie tych najpiękniejszych i najromantyczniejszych zdjęć. To chwila na oderwanie się od rzeczywistości i wcielenie w rolę
                        rozluźnionego modela. Spotkajmy się, wspólnie znajdźmy chwilę, światło, kadr, zachowajmy je na zawsze. Serdecznie zapraszam.
                    </p>
                    <LazyLoad offsetVertical={300}>
                        <img src={"/static/portfolio/sesja_zdjeciowa_krakow_4_portfolio.jpg"} />
                    </LazyLoad>
