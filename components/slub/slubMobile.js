            ...
            <div>
                <article>
                    ...
                    <p>
                        ...
                        Fotografia ślubna to jednocześnie zależnośc pomiędzy chwilą, światłem i kadrem. W obu przypadkach jest to zawsze kompromis poparty pomysłem i doskonałym warsztatem, który
                        pozwala ten pomysł zrealizować.
                    </p>
                    <Image alt="Dekoracja sali weselnej w stylu rustykalnym" src={"/static/portfolio/dekoracja_sali_weselnej_w_stylu_rustykalnym_osp_zawada_portfolio.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/dekoracja_sali_weselnej_w_stylu_rustykalnym_osp_zawada_portfolio.jpg"/>
                    <p>
                    ...
                    <Image alt="Miejsca, wydarzenia, emocje w fotografii ślubnej" src={"/static/portfolio/portfolio_0013.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/portfolio_0013.jpg"/>
                    <p>
                        ...
                        fotograficzny jest na pewno ważny, ale nie przeceniajmy jego wartości. W dzisiejszych czasach, ludzie bardzo często posługują się doskonałymi aparatami i obiektywami.
                    </p>
                    <Image alt="Ogromne możliwości w fotografii ślubnej" src={"/static/portfolio/portfolio_0001.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/portfolio_0001.jpg"/>
                    <p>
                    ...
                    <Image alt="Własny styl w fotografii ślubnej" src={"/static/portfolio/sala_weselna_nedan_pcim_reportaz_slubny_portfolio.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/sala_weselna_nedan_pcim_reportaz_slubny_portfolio.jpg"/>
                    <p>
                    ...
                    <Image alt="Autentyczne emocje w fotografii ślubnej" src={"/static/portfolio/portret_panny_mlodej.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/portret_panny_mlodej.jpg"/>
                    <p>
                    ...
                    <Image alt="Zdjęcia pełne kolorów i autentycznych emocji" src={"/static/portfolio/portfolio_0021.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/portfolio_0021.jpg"/>
                </article>
                ...
                <article>
                    ...
                    <p>
                        ...
                        cechami, których szukałam u fotografa ślubnego i które z pewnością znalazłam u Tomka. Piękne zdjęcia jednej z koleżanek nakłoniły nas do zmiany fotografa ślubnego na miesiąc
                        przed weselem, ale dziś patrząc na nasze fotografie wiem, że ta szalona decyzja była strzałem w dziesiątkę! Każdej parze poszukującej fotografa ślubnego z pełnym przekonaniem
                        polecamy Tomasza - choć reportaże na Jego blogu są chyba wystarczającą rekomendacją :) Raz jeszcze dziękujemy Ci Tomku za piękne i szybko oddane zdjęcia, współpracę z Tobą
                        będziemy zawsze miło wspominać! <Link href="/sala-weselna-nedan-pcim-reportaz-slubny">Anna i Krzysztof</Link>.
                    </p>
                    <Image alt="sala weselna Nedan Pcim" src={"/static/portfolio/portfolio_0015.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/dekoracja_sali_weselnej_w_stylu_rustykalnym_osp_zawada_portfolio.jpg"/>
                    <p>
                    ...
                    <Image alt="piękne zdjęcia, pełne emocji reportaże ślubne" src={"/static/portfolio/slubne_portfolio_2.jpg"} width={1140} height={763} placeholder="blur" blurDataURL="/static/portfolio/slubne_portfolio_2.jpg"/>
                    <p>
                    ...
                    <Image alt="samochód ślubny tesla" src={"/static/portfolio/martyna_slub_tesla.jpg"} width={1140} height={525} placeholder="blur" blurDataURL="/static/portfolio/martyna_slub_tesla.jpg"/>
                    <p>
                        Serdecznie polecamy Tomka! Świetny, bardzo profesjonalny fotograf, a jednoczesnie przesympatyczny i zawsze uśmiechnięty człowiek. Zdjęcia gotowe w ekspresowym tempie, a każde z
                        nich wyjątkowe. Pozostaną dla nas przepiękną pamiątką na zawsze! Tomku, to była prawdziwa przyjemność z Tobą współpracować! Bardzo dziękujemy za wszystko! Maria i Amaury
                    </p>
                    <Image alt="ślub w hotelu kasprowy zakopane" src={"/static/portfolio/patrycja_slub.jpg"} width={1140} height={761} placeholder="blur" blurDataURL="/static/portfolio/patrycja_slub.jpg"/>
                    <p>
                    ...
                    <Image alt="wesele w górskim klimacie" src={"/static/portfolio/wesele_w_goralskim_klimacie_willa_orchidea_waksmund_portfolio.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/wesele_w_goralskim_klimacie_willa_orchidea_waksmund_portfolio.jpg"/>
                    <p>
                    ...
                    <Image alt="sesja zdjęciowa kopiec kraka" src={"/static/portfolio/portfolio_0022.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/portfolio_0022.jpg"/>
                    <p>
                    ...
                    <Image alt="wesele na polu golfowym w Paczółtowicach" src={"/static/portfolio/wesele_na_polu_golfowym_w_paczoltowicach_portfolio.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/wesele_na_polu_golfowym_w_paczoltowicach_portfolio.jpg"/>
                    <p>
                    ...
                    <Image alt="Ślub w Bazylice Bożego Ciała w Krakowie" src={"/static/portfolio/portfolio_0017.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/portfolio_0017.jpg"/>
                    <p>
                    ...
                    <Image alt="dobry fotograf ślubny Kraków" src={"/static/portfolio/slubne_portfolio_1.jpg"} width={1140} height={595} placeholder="blur" blurDataURL="/static/portfolio/slubne_portfolio_1.jpg"/>
                    <p>
                    ...
                    <Image alt="sala weselna Alexandra Mszana Dolna" src={"/static/portfolio/aleksandra_mszana_dolna.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/aleksandra_mszana_dolna.jpg"/>
                    <p>
                    ...
                    <Image alt="pełne emocji reportaże ślubne, niezapomniane sesje plenerowe" src={"/static/portfolio/beata_marcin_mszana_dolna_portfolio.jpg"} width={1140} height={760} placeholder="blur" blurDataURL="/static/portfolio/beata_marcin_mszana_dolna_portfolio.jpg"/>
                    <p>
